module.exports = {
    ...
    history: {
        pageData : [
            ...
            {iconUrl: '#icon-biye', type: 'shu_dan', year: '2008.6', txt: 'I have been class leader for six years during school '},
            {iconUrl: '#icon-pingpangqiu1', type: 'shu_shuang', year: '2009.8', txt: 'Joining ping pang Competition'},
            {iconUrl: '#icon-18', type: 'shu_dan', year: '2014.2', txt: 'Be an adult'},
            {iconUrl: '#icon-daxue1', type: 'shu_shuang', year: '2014.9', txt: 'Went to the Collage, major in SoftWare Engineering'},
            {iconUrl: '#icon-diannao', type: 'shu_dan', year: '2016.7', txt: 'Beginning be a Web front development'},
