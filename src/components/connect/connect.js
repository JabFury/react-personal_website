            ...
            <div>
                <div className='connect_header'>
                    ...
                    <div className='icon_div'>
                        ...
                        <a target="_blank" href='https://weibo.com/5433476675/profile?rightmod=1&wvr=6&mod=personinfo&is_all=1'>
                            <svg className="connect_icon_svg" aria-hidden="true">
                        ...
                        <a style={{cursor:'pointer'}} onClick={()=>{this.setState({isShowWeChat: true})}}>
...

                {
                    this.state.isShowWeChat === true ?
                        <div onClick={()=>{this.setState({isShowWeChat: false})}}>
                            <div className={['wechat_model',this.state.isShowWeChat === true ? 'show_wechat_model' : null].join(' ')}></div>
                            <div className={['we-chat',this.state.isShowWeChat === true ? 'show_wechat' : null].join(' ')}>
