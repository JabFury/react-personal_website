            ...
            data: [
                {
                    ...
                    tooltip: {formatter: '2004-10 九寨沟，2008-6 成都，<br />2008-7 乐山，峨眉山，<br />2014-11 青城山，2016-10 西昌'}
                },
                {
                    name: '甘肃',
                    value: 0,
                    itemStyle: {areaColor: '#08ee65'},
                    tooltip: {formatter: '出生地  兰州，<br />2001-5 永登，2005-6 敦煌，<br />2013-12 嘉峪关'}
                },
                ...
                {name: '湖北', value: 0, itemStyle: {areaColor: '#ff973b'}, tooltip: {formatter: '2005-6 武汉'}},
                {
                    ...
                    tooltip: {formatter: '2008-7 三峡，2015-4 重庆，<br />2015-10 武隆'}
                },
            ...
            <div>
                ...
                </div>
                {
                    deviceName === "mobile" ? null :
                        <div
                            className={['foot_txt_div', isCurrentPage === true ? 'foot_article_div_active' : null].join(' ')}>
                ...
                <label
                    ...
                    style={deviceName==="mobile"?{width:'100%',textAlign:'center',left:0}:{}}
                >
                    {isChinese === true ? '分享一下我的足迹吧' : 'This is my FootPoint'}
                </label>
                <ReactEcharts
                    className={['myEcharts', isCurrentPage === true ? 'echart_active' : null].join(' ')}
                    style={deviceName==="mobile"?{width: '100vw', height: '75vh',left:0}:{width: '60vw', height: '75vh'}}
                    option={deviceName==="mobile"?option_mobile:option_pc}
                    lazyUpdate={true}
                />
                {
                    deviceName==="mobile"?
